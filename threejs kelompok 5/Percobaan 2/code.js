...
// Variabel untuk mengontrol kecepatan gerakan
const moveSpeed = 0.5;
...
function handleKeyDown(event) {
    switch (event.key) {
        ...
        case "ArrowRight": // Panah kanan
            ...
            cube.position.x += moveSpeed;
            break;
        case "w": // Tombol 'w' untuk menggerakkan ke atas
            sphere.position.y += moveSpeed;
            cube.position.y += moveSpeed;
            break;
        case "s": // Tombol 's' untuk menggerakkan ke bawah
            sphere.position.y -= moveSpeed;
            cube.position.y -= moveSpeed;
            break;
    }
...
// Menambahkan event listener untuk menangani keyboard
